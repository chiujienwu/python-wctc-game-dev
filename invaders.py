...
class Actor(cocos.sprite.Sprite):
    ...
    # offset is the distance to travel (in pixels) from current position
    ...
    def update(self, delta_time):
        ...
        # this is just a placeholder to be defined in subclass later
        pass
...
class PlayerCannon(Actor):
    ...
    def collide(self, other):
        ...
        # kill method is built into Cocos
        other.kill()
        self.kill()
    ...
    def update(self, delta_time):
        ...
        # print("self.parent.width: " + str(self.parent.width))
        # print(half_width <= self.x <= self.parent.width - half_width)
        # print("self.speed: " + str(self.speed))
        # print("horizontal_moment: " + str(horizontal_movement))
        # print("delta_time: " + str(delta_time))
        # print("self.move: " + str(self.speed * horizontal_movement * delta_time))

        new_vector = (self.speed * horizontal_movement * delta_time)
        new_x = new_vector[0]
        # print("new_x: " + str(new_x))

        if half_width <= self.x + new_x <= self.parent.width - half_width:
...
class GameLayer(cocos.layer.Layer):
    ...
    def update_score(self, points=0):
        ...
        # after score update, check to see if max score has been achieved
        # if 1000 is achieved then use show_game_over method in HUD
        if(self.score == 1000):
            self.hud.show_game_over("You win!")
        # during score update to the Game layer, also update the difficulty
        if (self.difficulty - points > 0):
            self.difficulty -= points
            # print("points: " + str(points))
            # print("score: " + str(self.score))
            # print("self.difficulty: " + str(self.difficulty))
            # print("self.speed_factor: " + str(self.speed_factor))
        else:
            self.difficulty = self.difficulty - points + 150
            # increase the speed factor by multiple of two each time a player reaches 150 points
            self.speed_factor = self.speed_factor * 2
            # print("self.difficulty reset")
    ...
    def game_loop(self, delta_time):
        ...
        # if player reaches 150 points, the delta time will be increased by a factor of two
        # this will increase movement speed of swarm
        self.swarm.update(delta_time * self.speed_factor)
